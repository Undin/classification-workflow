...
class ClassifierPerformanceEntity {
    ...
    constructor(classifierName: String, datasetName: String, measure: Double) {
    ...
    operator fun component2(): String = classifierName
    operator fun component3(): Double = measure

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other?.javaClass != javaClass) return false

        other as ClassifierPerformanceEntity
    ...
    override fun hashCode(): Int {
        var result = classifierName.hashCode()
